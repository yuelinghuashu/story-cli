...
[![Tests](https://img.shields.io/badge/tests-175%20passed-brightgreen?style=flat-square)](README.en.md#-Testing)
...
All 175 tests pass, covering: scanner, validation, template rendering, word counting, i18n, README generation, EPUB export (including cover images), argument parsing, repo config, CLI entry points, XSS protection, Markdown parsing edge cases, and init --full.
