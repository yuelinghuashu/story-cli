...
- **Compliance check** — `story validate` checks against Story-Repo spec (folder naming / UTF-8 / duplicate numbers / schema)
...
| `story validate [--json]`                                     | Compliance check (Story-Repo spec)                  |
| `story link "A" "B" [--remove=...] [--list]`                  | Manage related stories (weak relation)              |
| `story mcp-server`                                            | Start MCP Server (AI connection entry)              |

<details>
<summary>Full command reference</summary>

Full command list with aliases, subcommands, and parameters: see [commands.en.md](commands.en.md).
...
| **Command Reference** | [commands.md](docs/commands.md)           | [commands.en.md](docs/commands.en.md)           | All commands list     |
